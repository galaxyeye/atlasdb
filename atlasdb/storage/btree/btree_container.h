...
#ifndef ATLASDB_STORAGE_BTREE_BTREE_CONTAINER_H_
#define ATLASDB_STORAGE_BTREE_BTREE_CONTAINER_H_
  ...
  // A common base class for btree_set and safe_btree_set.
    ...
    public:
      ...
      btree_unique_container(InputIterator b, InputIterator e, const key_compare &comp = key_compare(),
          const allocator_type &alloc = allocator_type()) : super_type(comp, alloc) { insert(b, e); }
      ...
      void insert(InputIterator b, InputIterator e) { this->tree_.insert_unique(b, e); }
    ...
    public:
      ...
      template<typename InputIterator>
      void insert(InputIterator b, InputIterator e) { this->tree_.insert_multi(b, e); }
